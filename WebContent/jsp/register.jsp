		...
		<form class="form-horizontal" style="margin-top:5px;" method="post" action="${pageContext.request.contextPath }/userServlet">
			<input type="hidden" name="method" value="register">
			 <div class="form-group">
			    ...
			    <div style="color: red"><span id="s1"></span></div>
			  </div>
			   <div class="form-group">
			...
			<label class="radio-inline">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-2">
			    <img src="${pageContext.request.contextPath}/verificationCode" id="code"/>
			    </div>
...
<script type="text/javascript">
	$("#username").blur(function(){
		...
		var url = "/project1_mark/userServlet";
		$.post(url, {"method":"checkName", "username":username}, function(result){
...
<script type="text/javascript">
	$("#code").click(function(){
		this.src="${pageContext.request.contextPath}/verificationCode?time=" + new Date().getTime();
	})
</script>
</html>
